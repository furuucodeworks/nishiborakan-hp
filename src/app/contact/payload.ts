...
export function parseInquiryForm(
  formData: FormData,
): ContactState | { ok: true; fields: InquiryFields } {
...
export function toWeb3FormsBody(accessKey: string, fields: InquiryFields) {
  return {
    access_key: accessKey,
    subject: `【NISHIBORAKAN】${fields.inquiryType} / ${fields.name}`,
    from_name: "GUEST HOUSE NISHIBORAKAN",
    name: fields.name,
    email: fields.email,
    replyto: fields.email,
    message: formatInquiryMessage(fields),
  };
}
